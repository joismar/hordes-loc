export default {
  interactions: [{
    text: {
      ...
      pt: 'Mentes sobrecarregadas estão cheias de opiniões em abundância; um copo pode ser bastante útil se for encontrado vazio pela primeira vez. Como posso ajudá-lo em seu caminho para a iluminação?',
